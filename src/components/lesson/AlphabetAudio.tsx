...
const ROWS: Row[] = [
  { letter: "A a", name: "а",         example: "Apfel",    transcription: "ап-фель",     spell: "A" },
  { letter: "B b", name: "бе",        example: "Buch",     transcription: "бух",          spell: "B" },
  { letter: "C c", name: "це",        example: "Computer", transcription: "комп'ю́тер",   spell: "C" },
  { letter: "D d", name: "де",        example: "Danke",    transcription: "да́н-ке",      spell: "D" },
  { letter: "E e", name: "е",         example: "Elefant",  transcription: "еле-фа́нт",    spell: "E" },
  { letter: "F f", name: "еф",        example: "Foto",     transcription: "фо́-то",       spell: "F" },
  { letter: "G g", name: "ґе",        example: "gut",      transcription: "ґут",          spell: "G" },
  { letter: "H h", name: "га",        example: "Haus",     transcription: "гаус",         spell: "H" },
  { letter: "I i", name: "і",         example: "Idee",     transcription: "і-де́",        spell: "I" },
  { letter: "J j", name: "йот",       example: "ja",       transcription: "я",            spell: "J" },
  { letter: "K k", name: "ка",        example: "Kaffee",   transcription: "ка-фе́",       spell: "K" },
  { letter: "L l", name: "ель",       example: "Lampe",    transcription: "ла́м-пе",      spell: "L" },
  { letter: "M m", name: "ем",        example: "Mutter",   transcription: "му́-тер",      spell: "M" },
  { letter: "N n", name: "ен",        example: "Nacht",    transcription: "нахт",         spell: "N" },
  { letter: "O o", name: "о",         example: "Obst",     transcription: "обст",         spell: "O" },
  { letter: "P p", name: "пе",        example: "Park",     transcription: "парк",         spell: "P" },
  { letter: "Q q", name: "ку",        example: "Quiz",     transcription: "квіц",         spell: "Q" },
  { letter: "R r", name: "ер",        example: "Rose",     transcription: "ро́-зе",       spell: "R" },
  { letter: "S s", name: "ес",        example: "Sonne",    transcription: "зо́-не",       spell: "S" },
  { letter: "T t", name: "те",        example: "Tee",      transcription: "те",           spell: "T" },
  { letter: "U u", name: "у",         example: "Uhr",      transcription: "ур",           spell: "U" },
  { letter: "V v", name: "фау",       example: "Vater",    transcription: "фа́-тер",      spell: "V" },
  { letter: "W w", name: "ве",        example: "Wasser",   transcription: "ва́-сер",      spell: "W" },
  { letter: "X x", name: "ікс",       example: "Taxi",     transcription: "та́-ксі",      spell: "X" },
  { letter: "Y y", name: "іпсилон",   example: "Yoga",     transcription: "йо́-ґа",       spell: "Y" },
  { letter: "Z z", name: "цет",       example: "Zeit",     transcription: "цайт",         spell: "Z" },
  { letter: "Ä ä", name: "е-умлаут",  example: "Äpfel",    transcription: "е́п-фель",     spell: "Ä" },
  { letter: "Ö ö", name: "о-умлаут",  example: "Öl",       transcription: "оьль",         spell: "Ö" },
  { letter: "Ü ü", name: "у-умлаут",  example: "über",     transcription: "ю́-бер",       spell: "Ü" },
